...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className={`no-print fixed right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-maroon text-cream shadow-lg shadow-maroon/30 transition-transform hover:scale-105 hover:bg-maroon-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold ${
